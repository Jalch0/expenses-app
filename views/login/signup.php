...
<body>
    <img src="<?php echo constant('URL'); ?>public/img/login-photos/IMG_20220201_130203.jpg" alt="fotomedia" class="mediaphoto">
    <div class="login-container">
        <div class="login-main">
            <form action="<?php echo constant('URL'); ?>signup/newUser" method="POST">
                ...
                <input type="submit" class="btn" value="Crear nuevo usuario" />
                <p class="accountexist">
